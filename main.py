...
# Note: The database credentials should be handled securely (e.g., using environment variables).
engine = "postgresql+psycopg2://postgres:***********/recipe_app"
db=DbManager(engine)


class Ingredient(BaseModel):
    """Pydantic model for creating a new ingredient (all fields required)."""
    name: str
    description: str
    unit: str
    calories: float
...
class UpdateIngredient(BaseModel):
    """
    Pydantic model for updating an ingredient.
    Fields are optional (Union[Type, None] = None).
    """
    name: str| None = None
...
class Recipe(BaseModel):
    """Pydantic model for creating a new recipe (all fields required)."""
    name: str
    description: str
    instructions: str
    servings: int
...
class UpdateRecipe(BaseModel):
    """
    Pydantic model for updating a recipe.
    Fields are optional.
    """
    name: str| None = None
    description: str| None = None
